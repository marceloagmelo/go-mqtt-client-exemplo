...
func main() {
	topic := flag.String("topic", "007a654c/teto/status", "The topic name to/from which to publish/subscribe")
	broker := flag.String("broker", "tcp://192.168.68.145:1883", "The broker URI. ex: tcp://10.10.1.1:1883")
	password := flag.String("password", "", "The password (optional)")
	user := flag.String("user", "marcelo", "The User (optional)")
